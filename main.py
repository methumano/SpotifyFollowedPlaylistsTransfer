...
def get_token(scope):
    ...
    user_response = input(
        '\nCopy and paste the following URL into your browser, and allow the web app the necessary permissions...'
        f'\nhttps://accounts.spotify.com/authorize?client_id={secrets.client_id}&response_type=code&redirect_uri={encoded_redirect_uri}&scope={scope}\n'
        '\nYou should then be redirected to another webpage. Please copy the URL and paste below...\n')
